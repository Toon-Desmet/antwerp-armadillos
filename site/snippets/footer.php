    <footer class="footer">
        ...
        <div class="footer--element footer--link-element">
            ...
            <div>
                <a href="<?= $site->facebook()->html() ?>" target="_blank"><img src="<?= url('assets/images/Facebook.svg') ?>" alt="link to facebook"></a>
                <a href="<?= $site->instagram()->html() ?>" target="_blank"><img src="<?= url('assets/images/instagram.svg') ?>" alt="link to instagram"></a>
            </div>
        </div>
